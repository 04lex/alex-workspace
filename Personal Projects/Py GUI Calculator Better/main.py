...
class Calculator:
    def __init__(self):
        ...
        self.window.title("Better Calculator")
    ...
    # bind keyboard for kb use
    def bind_keys(self):
        # this will know that enter does the same thing as equal btn
    ...
    def create_display_labels(self):
        total_label = tk.Label(self.display_frame, text=self.total_expression, anchor=tk.E, bg=LIGHT_GRAY, fg=LABEL_COLOR, padx=24, font=SMALL_FONT_STYLE) # anchor = position of the text (EAST)
    ...
    def create_digit_buttons(self):
        for digit, grid_value in self.digits.items():
            ...
            button.grid(row=grid_value[0], column=grid_value[1], sticky=tk.NSEW) # sticky, fills up the entire label North, S, E, W
