...
if __name__ == "__main__":
    ...
    # ap.add_argument("-f", "--input", required=True, help="path to PDF document")
    # args = vars(ap.parse_args())

    # in_file = args["input"]
    in_file = "/Users/stefan/Desktop/LinkAcademy/Python_Track/__22_23/Graphic Applications/curs4/sample.pdf"
    filename_base = in_file.replace(os.path.splitext(in_file)[1], "")

    # Provide replacements list that you need here
    replacements = { 'PDF': 'DOCUMENT'}
